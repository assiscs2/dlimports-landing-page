      ...
      <div className="w-full">
        ...
        <header className="bg-[#7f11BB] h-[4rem] flex items-center justify-center text-yellow-200 lg:h-24">
          <a href="https://www.dlimport.com.br/"
            target="_blank"
          >
            <Image src={logoDLimports} height={120} width={240} alt="logo Maloni Gold" className="h-12 w-auto" />
          </a>
        </header>
        <div
            ...
            <div className="flex flex-col w-full h-auto justify-center items-center">
              <div className="flex gap-2">
                <div className=" w-full h-auto flex flex-col px-4 py-2 gap-4 ">
                  <div className="w-auto">
                    <div className="bg-gray-600 h-44 w-auto flex items-center justify-center mt-2">
                      IMAGEM
                    </div>
              ...
              <div>
                ...
                <div className="text-center pt-4 px-4 w-full mx-auto max-w-[820px] p">
                  <div className="bg-gray-600 h-44 w-auto flex items-center justify-center">
                    IMAGEM
                  </div>
                  <div>
                    <p className="mt-4">
